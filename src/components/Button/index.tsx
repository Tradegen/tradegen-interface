...
export const ButtonPrimary = styled(Base)`
  ...
  color: white;
  &:focus {
    box-shadow: 0 0 0 1pt ${darken(0.05, '#5271FF')};
    background-color: ${darken(0.05, '#5271FF')};
  }
  &:hover {
    background-color: ${darken(0.05, '#5271FF')};
  }
  &:active {
    box-shadow: 0 0 0 1pt ${darken(0.1, '#5271FF')};
    background-color: ${darken(0.1, '#5271FF')};
  }
  &:disabled {
