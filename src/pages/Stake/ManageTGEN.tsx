...
export default function ManageTGEN() {
  ...
  let data2 = useUserTradegenStakingInfo(account);
  ...
  const userValueInCUSD = (TGENPrice) ? (TGENPrice * BigInt(userTokensStaked) / BigInt(1e18)) : undefined;
  ...
  const userLiquidityUnstaked = useTokenBalance(account, new Token(NETWORK_CHAIN_ID, TGEN, 18))
    ...
    <PageWrapper gap="lg" justify="center">
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
        ...
        {!showAddLiquidityButton && (
          <DataRow style={{ marginBottom: '1rem' }}>
            <ButtonPrimary padding="8px" borderRadius="8px" width="160px" onClick={handleDepositClick}>
              {userTokensStaked.toString() != "0" ? 'Deposit' : 'Deposit TGEN tokens'}
            </ButtonPrimary>
        ...
        {userLiquidityUnstaked && userLiquidityUnstaked.toString() != "0" && (
          <TYPE.main>{formatBalance(userLiquidityUnstaked.raw.toString())} TGEN tokens available</TYPE.main>
        )}
      </PositionInfo>
    </PageWrapper>
  )
