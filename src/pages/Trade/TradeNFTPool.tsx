import { TradeNFTPool } from '../../features/NFTPools/Trade'
...
export default function TradeNFTPoolPage({
        match: {
            params: { id },
        },
    ...
    return (
        <>
            <TradeNFTPool address={id} account={account} mcUSDBalance={mcUSDBalance} totalSupply={totalSupply} maxSupply={maxSupply} tokenPrice={tokenPrice}></TradeNFTPool>
        </>
    )
}